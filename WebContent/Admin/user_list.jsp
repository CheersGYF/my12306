...
<%@ page import="com.neuedu.my12306.model.User" %>
    ...
    <td width="835" background="../images/wb_01 (3).jpg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table width="553" border="1" align="center" cellpadding="0" cellspacing="1" bordercolor="#dadada" bgcolor="#FFFFFF">
          ...
          <%
          	// 1.使用request请求对象获取servlet传递过来的对象
          ...
          <tr align="center" bgcolor="<%=index%2==1?"#FFFFFF":"#F5F5F5"%>">
            <td bordercolor="#FFFFFF"   class="text_cray1"><input type="checkbox" name="checkbox" value="<%=user.getId() %>">            </td>
            <td width="98" bordercolor="#FFFFFF"  class="text_cray1"><%=user.getUserName() %></td>
            <td width="80" bordercolor="#FFFFFF"  class="text_cray1"><%=user.getSex().equals("1")?"男":"女" %></td>
            <td width="132" bordercolor="#FFFFFF"  class="text_cray1"><%=user.getCertType() %></td>
            <td width="247" bordercolor="#FFFFFF"  class="text_cray1"><%=user.getCert() %></td>
            <td width="82" bordercolor="#FFFFFF"  class="text_cray1"><%=user.getUserType() %></td>
